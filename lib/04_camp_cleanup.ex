defmodule AdventOfCode.CampCleanup do
  ...
  """
  @spec assignment_pairs_2(String.t(), []) :: pos_integer()
  def assignment_pairs_2(data, opts \\ []) do
    path = Keyword.get(opts, :path, "priv/input/")
  ...
  defp count_overlaps_any(data) do
    Enum.reduce(data, 0, fn x, acc ->
      if overlaps_any?(x) do
        acc + 1
      else
        acc
      end
